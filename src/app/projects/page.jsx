    ...
    <section className="flex h-full">
      <div>
        <div className="flex h-[41px] w-[311px] items-center gap-[11px] border-b border-r border-lines pl-5">
          <Icon icon="folder-green" size={24} /> projects
        </div>
      ...
      <div className="flex w-full flex-col">
        <div className="flex h-[41px] w-full border-b border-lines">
          <div className="flex h-[41px] w-fit items-center gap-[48px] border-r border-lines pl-3.5 pr-3 ">
            portfolio-final.jsx <Icon icon="close" size={20} />
          </div>
        </div>
